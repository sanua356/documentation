...
## Introduction[​](#start "Direct link to heading")
...
## Cross-import solutions options[​](#solutions "Direct link to heading")

### Merging multiple slices into one[​](#slices-merge "Direct link to heading")
...
### Moving code to a higher layer[​](#slices-moving "Direct link to heading")
...
### Duplication code[​](#duplication-code "Direct link to heading")
...
## What if cross-import is inevitable?[​](#cross-import-is-inevitable "Direct link to heading")
...
### @x[​](#export-private-api "Direct link to heading")
...
### Lifting the ban on cross-imports[​](#disable-cross-imports-rule "Direct link to heading")
