...
## Introduction[​](#start "Sarlavhaga to'g'ridan-to'g'ri havola")
...
## Cross-import solutions options[​](#solutions "Sarlavhaga to'g'ridan-to'g'ri havola")

### Merging multiple slices into one[​](#slices-merge "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### Moving code to a higher layer[​](#slices-moving "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### Duplication code[​](#duplication-code "Sarlavhaga to'g'ridan-to'g'ri havola")
...
## What if cross-import is inevitable?[​](#cross-import-is-inevitable "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### @x[​](#export-private-api "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### Lifting the ban on cross-imports[​](#disable-cross-imports-rule "Sarlavhaga to'g'ridan-to'g'ri havola")
...
## Useful links[​](#useful-links "Sarlavhaga to'g'ridan-to'g'ri havola")
